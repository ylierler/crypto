...
to the N-Queens Puzzle}. To do so, we start by rewriting these rules in a numeric normal form.
...
\begin{align}
&\forall I \forall J \forall  K (d1(I,J,I-J+K) \rightarrow (1\leq I\leq K\wedge 1\leq J\leq K \wedge K=n)).\label{f:d1}\\
&\forall I \forall J \forall K (d2(I,J,I+J-1) \rightarrow (1\leq I\leq K\wedge 1\leq J\leq K \wedge K=n)).\label{f:d2}
\end{align}
...
\begin{align}
&\forall N V(V\in s_6(N) \leftrightarrow \exists I J( (I,J)\wedge q(I,J)\wedge d1(I,J,N))).\label{f:s6}\\
&\forall N V(V\in s_7(N) \leftrightarrow \exists I J( (I,J)\wedge q(I,J)\wedge d2(I,J,N))).\label{f:s7}
\end{align}
Now,  
